...
public class Tabuleiro extends JFrame {
    ...
    private long tempoAtualizacao = 200; // Velocidade inicial mais lenta
    ...
    private void Reiniciar() {
        ...
        tempoAtualizacao = 200; // Reseta para velocidade inicial
        gerarNovaMaca();
        painel.repaint();
    ...
    private void moverCobra() {
        ...
        // Reaparecimento do outro lado ao colidir com as bordas
    ...
    private void aumentarDificuldade() {
        if (tempoAtualizacao > 100 && placar % 5 == 0) {
            tempoAtualizacao -= 10;
        }
    }
